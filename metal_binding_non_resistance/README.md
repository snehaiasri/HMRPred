...
These filtered sequences were subsequently evaluated using HMRPred. Notably, 97.8% of iron-binding proteins and  82.3% of zinc-binding proteins were correctly classified as non-HMR, despite being predicted as metal-binding proteins by MeBiPred. This targeted validation demonstrates that HMRPred effectively distinguishes functional heavy metal resistance proteins from general metabolic metalloproteins, thereby providing a clear advantage over generic metal-binding predictors that do not incorporate resistance-specific functional context.
